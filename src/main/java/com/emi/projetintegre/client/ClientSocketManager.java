...
public class ClientSocketManager implements CommunicationManager {
    ...
    private void initializeManagers() {
        // Lambda for send functionality
        Function<Object, Boolean> sendFunction = this::send;
        // Lambda for checking connection status
        Function<Void, Boolean> isConnectedFunction = v -> isConnected();
        // Lambda for checking authentication status
    ...
    public void connect() {
        try {
            ...
            initializeManagers(); // Reinitialize managers with new streams
        } catch (Exception e) {
            disconnect();
    ...
    public ObservableList<PersonalDocument> getListDocuments() {
        return documentManager.getListDocuments();
    }
    ...
    public void disconnect() {
        try {
            ...
            initializeManagers(); // Reinitialize managers with null streams
        }
    }
}