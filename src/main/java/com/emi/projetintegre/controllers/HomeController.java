...
public class HomeController {
    ...
    private void showFileActionMenu(PersonalDocument document, Button anchor) {
        try {
            ...
            controller.setOnActionComplete(this::populateTables);
    ...
    private void populateTables() {
        ...
        if (clientSocketManager == null || !clientSocketManager.isConnected()) {
            ...
            documents = clientSocketManager.getListDocuments();
            if (documents.isEmpty()) {
                showAlert("No Documents", "No documents found on the server.");
            }
        }
    ...
    private void handleUploadAction() {
        ...
        try {
            ...
            controller.setClientSocketManager(clientSocketManager);
            controller.setOnUploadSuccess(this::populateTables);
    ...
    private void handleSearchAction() {
        ...
        if (!query.isEmpty() && clientSocketManager != null) {
